            ...
            <div class="scroll-sidebar" >
                    ...
                    <div class="user-pro-body">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu animated flipInY">
                                ...
                                <div class="dropdown-divider"></div>
                                <!-- text-->
                                <a href="javascript:void(0)" onclick="reqLogoutNow();" class="dropdown-item"><i class="ti-share"></i> Logout</a>
                                <!-- text-->
                            </div>
                        </div>
                    </div>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
						...
						<i class="icon-speedometer"></i><span class="hide-menu">Dashboard <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                            <ul aria-expanded="false" class="collapse in">
                               <li><a href="/auth_dashboard">Startup Page</a></li>
                                <li><a href="/user_auth">Add User Record</a></li>
                                <!--<li><a href="/view_record">Client Record</a></li>-->
                                <li><a href="/file_manager">Shipment</a></li>
